 ...
 * Перечисления, или enum, — это специальный тип класса, полезный для объявления коллекции констант,
 * известных как перечисляемые типы
 *
 * [valueOf] возвращает enum константу по названию. Если такой константы нет, брocает [java.lang.IllegalArgumentException]
