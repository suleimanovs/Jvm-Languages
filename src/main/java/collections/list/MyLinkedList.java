...
/**
 * Алгоритмическая сложность операций в коллекции LinkedList(связанный список):
 * - @get(index) - Получение элемента по индексу - O(N)
 * + @add(index) - Вставка элемента в конец списка - O(1)
 * + @remove(index) - Удаление элемента из коллекции по индексу в LinkedList - O(1)
 * + @add(element,index) - Вставка элемента в середину списка или в начало LinkedList - O(1)
 * <p>
